...
def run_context_test_suite():
    ...
    # ---------------------------------------------------------------------
    logger.info("--- Test 1: Sliding Window & Tail Clamping (Task 1) ---")
    ...
    logger.info(f"✅ State externalized: {len(total_stored)} messages confirmed in SQLite.")
    ...
    logger.info("✅ Tail clamping verified: Retrieved strictly the last 6 messages in chronological order.")
    ...
    logger.info("✅ Debrief compaction verified: 1-line atomic pointer stored in chat table.")
    ...
    logger.info("✅ Telemetry generation verified: Real performance metrics captured into compact context block.")
    ...
    logger.info("✅ Manual episodic eviction verified: Chat ledger successfully cleared.")
    ...
    logger.info("✅ Mutation episodic eviction verified: Program mutation automatically evicted stale split context.")
